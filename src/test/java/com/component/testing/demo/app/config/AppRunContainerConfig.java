package com.component.testing.demo.app.config;
...
public class AppRunContainerConfig {

    private static final Logger logger = LoggerFactory.getLogger(AppRunContainerConfig.class.getName());
    ...
    public PostgreSQLContainer getPostgres() {
        return new PostgreSQLContainer<>("postgres:15-alpine")
            ...
            .withReuse(true); // in addition, testcontainers.reuse.enable=true in config home/{user}/.testcontainers.properties
    }
